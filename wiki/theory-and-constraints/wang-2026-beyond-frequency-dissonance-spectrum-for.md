...
source: wang-2026-beyond-frequency-dissonance-spectrum-for.md
tags: ["dissonance","music-theory","inductive-bias","audio-representation","music-emotion","evaluation-validity"]
---

## Summary

Dissonance Spectrum (DS) converts CQT magnitudes into a map of amplitude-weighted rational pitch relations. The map can be inspected and added through a small residual branch to music QA and emotion models. It reports higher six-seed means than baseline, Gaussian, and CQT controls, with smaller gains over CQT and explicit limits on perceptual interpretation. [PDF pp. 2–7]

**Evidence boundary:** no supplied or publicly linked code archive was available for inspection. All model results remain paper-reported. Controlled ranks are largely theory-derived, and the corrected exact sign tests do not establish significance at .05.

## Key Contributions

DS's primary contribution is an explicit computational music-theory relation, so it is categorized under theory-and-constraints rather than generic representation or generation. It implements no hard generative constraint. Binwise mathematical attribution is distinct from a faithful explanation of a downstream neural prediction. [PDF pp. 2–5, 7]
...
![DS adapter in both host models](assets/wang-2026-beyond-frequency-dissonance-spectrum-for/fig-4-adapters.png)

Figure 4 (PDF p. 6) shows host queries, DS keys/values, and frozen/trainable modules. Zero-initialized output projection preserves the initial host function.
...
![Interval validation](assets/wang-2026-beyond-frequency-dissonance-spectrum-for/fig-5-intervals.png)

Figure 5 (PDF p. 6) compares audio DS, the sampled relation curve, and a predefined rank reference. Agreement with that reference is not a listener preference experiment.

![Paired primary-endpoint inference](assets/wang-2026-beyond-frequency-dissonance-spectrum-for/table-17-paired-tests.png)

Supplement Table 17 (PDF p. 19) makes the distinction between paired-t and corrected exact sign tests explicit.
...
- [[concepts/music-domain-inductive-biases]] — primary existing reciprocal synthesis anchor for explicit theory-derived priors.
- [[concepts/dissonance-spectrum]] — reusable definition, attribution, and evidence boundaries.
- [[concepts/music-theory-probing]] — contrast between constructing a musical relation and testing its recoverability.
