...
MI-MIDI combines controlled probes, prediction lenses, prompt patching, and bidirectional activation steering to distinguish accessible musical information from interventions that change symbolic generation.

## 1. Document Information

arXiv 2608.06638v1, dated 6 August 2026; thirteen pages including references. Public preprint with CC BY-NC-SA 4.0 declared in PDF metadata. The printed title and author names are retained. No LaTeX or experimental archive was supplied.

## 2. Key Contributions

- Comparative probing on full generations and controlled SynTheory MIDI.
- Classic/tuned lenses plus vocabulary-mass analysis distinguish readout geometry from prediction refinement.
- Instrument prompt patching supplies bounded causal evidence.
- Paired direction reversals separate directional control from symmetric disruption. [PDF pp. 2–12]
...
[[explainability-and-auditability/wei-2024-do-music-generation-models-encode|Wei et al.]] is directly cited and supplies SynTheory. MI-MIDI adds symbolic interventions but neither repairs nor reproduces Wei et al.'s audio evaluation. [[concepts/music-theory-probing]] is the primary synthesis anchor. Applying these methods to [[generation-and-planning/guo-2025-moonbeam-a-midi-foundation-model|Moonbeam]] or [[generation-and-planning/wang-2025-notagen-advancing-musicality-in-symbolic|NotaGen]] remains a repository proposal, not an experiment in MI-MIDI.

## 7. Glossary

- **Lift:** probe accuracy minus majority-class accuracy.
- **Predictive alignment:** activation used to predict a token, before consuming that token.
- **Logit lens:** read an intermediate state through the model's final output map.
- **Tuned lens:** trained affine translation before that fixed output map.
- **Activation patching:** substitute states from a contrasting input.
- **One-to-all:** inject one source-layer direction at every layer.
- **Specificity:** antisymmetric share of the measured response under direction reversal.
